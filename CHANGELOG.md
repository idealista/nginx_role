...
- *[#114](https://github.com/idealista/nginx_role/issues/114) fix files and directories permissions; RENAMED luaJIT_ variables to luajit_ because naming compliance (BREAKING) * @frantsao
